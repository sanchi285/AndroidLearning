...
public class MenuCourseActivity extends AppCompatActivity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_menu_course);
        ListView mainCoursesList = findViewById(R.id.list_menu_view);
        Dish[] mainCourses = {
                new Dish("Sanchi's salad", "A crisp salad featuring fresh thai basil and mulberry", 1499),
        ...
        ArrayAdapter<Dish> dishArrayAdapter = new ArrayAdapter<>(this,
